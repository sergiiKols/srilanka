-- ================================================================
-- ИСПРАВЛЕНИЕ ФУНКЦИИ archive_property
-- Проблема: forward_from_date должно быть forward_date
-- ================================================================
...
BEGIN
  ...
  -- Вставляем в архив (ИСПРАВЛЕНО: forward_date вместо forward_from_date)
