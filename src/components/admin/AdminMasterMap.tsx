...
export default function AdminMasterMap() {
    ...
    return (
        <div className="relative w-full h-full">
            ...
            {/* Панель управления */}
            <div 
                className={`absolute top-0 left-0 h-full w-full md:w-96 bg-white shadow-[8px_0_32px_-8px_rgba(0,0,0,0.3)] transform transition-transform duration-300 ease-in-out flex flex-col z-[2000] ${isControlPanelOpen ? 'translate-x-0' : '-translate-x-full'}`}
                style={{ pointerEvents: 'auto' }}
            >
                <div className="p-5 border-b bg-white sticky top-0 z-10">
                    <div className="flex justify-between items-center mb-3">
                        <h2 className="text-lg font-bold">🎛️ Admin Master Map</h2>
                        <button
